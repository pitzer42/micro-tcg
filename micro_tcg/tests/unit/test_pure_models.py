...
class TestResourcePool(unittest.TestCase):
    ...
    def test_resource_has_one_attribute_for_each_type_of_resource(self):
        res_pool = Resource()
        for res_type in TestResourcePool.expected_resource_types:
    ...
    def test_resource_is_immutable(self):
        ...
        def change_pool():
            res_type = TestResourcePool.expected_resource_types[0]
    ...
    def test_a_type_of_resource_is_not_enough_to_pay_for_a_different_type_of_cost(self):
        res_type_a = TestResourcePool.expected_resource_types[0]
        res_type_b = TestResourcePool.expected_resource_types[1]
        pool = Resource(**{
            res_type_a: 1
        })
        cost = Resource(**{
